...
public class MybatipseConstants {
	...
	public static final List<String> STATEMENT_ANNOTATIONS = Arrays.asList(ANNOTATION_SELECT, ANNOTATION_INSERT, ANNOTATION_UPDATE, ANNOTATION_DELETE,
			ANNOTATION_SELECT_PROVIDER, ANNOTATION_INSERT_PROVIDER, ANNOTATION_UPDATE_PROVIDER, ANNOTATION_DELETE_PROVIDER);

	public static final List<String> PROVIDER_ANNOTATIONS = Arrays.asList(ANNOTATION_SELECT_PROVIDER, ANNOTATION_INSERT_PROVIDER,
			ANNOTATION_UPDATE_PROVIDER, ANNOTATION_DELETE_PROVIDER);

	public static final List<String> PROVIDER_ANNOTATION_NAMES = Arrays.asList("SelectProvider", "InsertProvider", "UpdateProvider",
			"DeleteProvider");
	...
	static {
		...
		if (springConfigContentType == null) {
			...
			springConfigContentType = contentTypeManager.getContentType(CONTENT_TYPE_SPRING_CONFIG_STS);
		}
	}
