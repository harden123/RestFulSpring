...
public abstract class MybatisLogBinder {
	...
	private static final List<String> nonQuotedTypes = Arrays.asList("Integer", "Long", "Double", "Float", "Boolean");
	...
	protected static String extractStatementLine(String src) {
		...
		if (sqlPrefixStart == -1) {
			throw new IllegalArgumentException("Couldn't find the prefix of SQL statement line: '" + PREFIX_SQL + "'");
		}
	...
	protected static String extractParametersLine(String src) {
		...
		if (paramsPrefixStart == -1) {
			throw new IllegalArgumentException("Couldn't find the prefix of parameters line: '" + PREFIX_PARAMS + "'");
		}
		...
		if (nextSqlStartPos > -1 && (nextSqlStartPos < terminatorPos || terminatorPos == -1)) {
			...
			throw new IllegalArgumentException(
					"Failed to parse the parameters. Be sure to include the string '" + TERMINATOR + "' in the selection.");
		}
	...
	public static void main(String[] args) {
		String s = " ==>  Preparing: SELECT id,area_code,area_name,type,time_str,result,gmt_modify FROM dp_screen_statistic WHERE ( ( area_code = ? and type = ? and time_str = ? ) ) \r\n"
				+ " 2023-07-13 11:27:11.655 DEBUG 1 --- [nio-8080-exec-3] c.c.g.w.d.m.s.D.selectByExample          : ==> Parameters: 0033000100000000000000000000000000000000(String), provinceTotal(String), 20230712(String)\r\n"
				+ " 2023-07-13 11:27:11.656 DEBUG 1 --- [nio-8080-exec-3] c.c.g.w.d.m.s.D.selectByExample          : <==      Total: 1";
